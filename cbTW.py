...
def calculate_risk_score(
    *,
    ...
    # These are the probability factors
    ...
    # This works out the probability score
    ...
    # This works out the impact score
    impact_weighted = sum(
    ...
    # Converts it back to a score out of 5
